        ...
        Scaffold(
            ...
            Column(
                ...
                DisplayTasks(
                    ...
                    onComplete = { task, complited ->
                        viewModel.setAction(
                            action = TaskAction.SetCompleted(task, complited)
                        )
                    },
                )
                Spacer(
...
fun DisplayTasks(
    ...
    if (showDialog) {
        AlertDialog(
            ...
            text = {
                Text(
                    text = "Are you sure you wont to remove '${taskToDelete!!.title}'?",
    ...
    Column(
        ...
        Text(
            text = if (showActive) "Activity Tasks" else "Completed Tasks",
